...
<template>
    ...
    <div class="container">
        <div class="row mb-2">
            ...
            <div class="col-auto">
                <button type="button" @click="deleteevent" class="btn btn-sm btn-danger">Delete</button>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-auto">
...
<div class="col-4" v-if="oldimage" >
          <div class="form-group">
            <label for="imageid">Image</label>
            <div>
                <img style="width:175px;" :src="'http://127.0.0.1:8000/storage/' + oldimage"/>
            </div>
          </div>
        </div>
        <div class="col-12">
  ...
  self=this;
      axios.get('http://127.0.0.1:8000/api/event/edit/'+this.$route.params.id)
          .then(function(response){
              ...
              self.oldimage=response.data.data.image;
          })
 ...
 deleteevent(){
     self=this;
      var formdata= new FormData();
       formdata.append('event_id',self.event_id);
    axios.post('http://127.0.0.1:8000/api/event/delete',formdata ,{
          headers: {
                 'Content-Type': 'multipart/form-data'
                }
            }
